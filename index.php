<?php
session_start();
include("wiser/include/header_outside.php");
...
==========================*/
    ...
    .item-bg1 {
        ...
        background-image: url(wiser/img/banner/banner.png);
    }

    .item-bg2 {
        /* https://techsolutionshere.com/wp-content/uploads/2019/01/s2.jpg */
        background-image: url(wiser/img/banner/banner2.png);
    }

    .item-bg3 {
        background-image: url(wiser/img/banner/bradcam.png);
    }
...
<div id="home" class="hero-slider owl-carousel owl-theme">
    <div class="single-hs-item item-bg1">
        <div class="d-table">
            <div class="d-tablecell">
                <div class="hero-text">
                    <h1 class="">Welcome To Smart Institute</h1>
    ...
    <div class="single-hs-item item-bg2">
        <div class="d-table">
            <div class="d-tablecell">
                <div class="hero-text">
                    <h1 class="text-uppercase">Special Facilities</h1>
    ...
    <div class="single-hs-item item-bg3">
        <div class="d-table">
            <div class="d-tablecell">
                <div class="hero-text">
                    <h1 class="text-lowercase">Beautiful infrastructure</h1>
...
<a class="btn mt-5" data-toggle="modal" data-target="#exampleModal"></a>
...
<div class="container p-5 mt-5">
    <div class="row">
        <div class="col-md-6 ">
            <img src="./wiser/img/aboutus.png" class="img-responsive w-100 animate__animated animate__fadeInUp" alt="No image">
        </div>
        <div class="col-md-6">
            <h1 class="font-weight-bold border border-top-0 border-left-0 animate-box animate__animated animate__fadeInUp  border-right-0  p-3 border-primary">
                <a href="./wiser/about.php">
                    <span class="" style="color: #2496b9;">A</span>bout
                    <span class="" style="color: #2496b9;"> U</span>s
            </h1>
            <p class="p-4 text-justify animate__animated animate__fadeInUp">
                Smart Institute of science & Technology is a leading institution of professional studies.30 Years of Experiance of Quality Computer Education Affilated By Makhanlal chaturvedi university.Since its inception in 2004, Smart Institute has been offering the most effective and extensive IT education in Bhopal with a view to blend traditional values and business education.
                <br>
            ...
            <div class="col-lg-12">
                <nav class="custom_tabs text-center">
                    <div class="nav" id="nav-tab" role="tablist">
                        ...
                        <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Diploma</a>
                                ...
                                <div class="p-5">
                                    <h3 class="text-center"><?= $row['subtitle']; ?></h4>
                                        <p class="text-center"><?php
                                                                ...
                                                                echo $small; ?>..</p>
                                        <a href="wiser/Courses.php" class="boxed-btn5 mt-3 mx-auto d-block">Apply Now</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                ...
                <div class="row">
                    <?php while ($row = mysqli_fetch_assoc($coursesP)) { ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="single__program">
                                <div class="program_thumb">
                                    <img src="assets/img/<?= $row['imgname']; ?>" class="border" style="width:100%;height:300px" alt="">
                                ...
                                <div class="p-4">
                                    ...
                                    <p class="text-center"><?php
                                                            ...
                                                            echo $small; ?></p>
                                    <a href="wiser/Courses.php" class="boxed-btn5 mx-auto d-block">Apply Now</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                            ...
                            <div class="single__program">
                                ...
                                <div class="p-4">
                                    ...
                                    <p clas="text-center">
                                        ...
                                        echo $small; ?>..</p>
                                    <a href="wiser/Courses.php" class="boxed-btn5 d-block">Apply NOw</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="course_all_btn text-center">
                    <a href="wiser/Courses.php" class="boxed-btn4">View All course</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            ?>
                                <div class="single_wrap">
                                    ...
                                    <p class="text-left   ">
                                        ...
                                        echo $small; ?></p>
                                    <a href="wiser/Courses.php" class="boxed-btn5">Apply Now</a>
                                </div>
                            <?php  } ?>
                            <!-- <div class="single_wrap">
                                    <div class="icon">
                    ...
                    <ul class="glide__slides">
                        <?php while ($row = mysqli_fetch_assoc($termss)) { ?>
                            <li class="glide__slide border  border-info border-left-0 border-right-0" style="">
                                ...
                                <div class="card-body">
                                    <a href="wiser/contact.php" class="boxed-btn5 mx-auto d-block">Apply Now</a>
            ...
            <?php while ($row = mysqli_fetch_assoc($newss)) { ?>
                <div class="col-md-4">
                    <div class="single__news">
                        ...
                        <div class="news_info">
                            <a href="wiser/news-detail.php?id=<?= $row['temp'];  ?>">
...
<?php include("wiser/include/footer_outside.php"); ?>