                 ...
                 <div class="col-xl-3 col-md-6 col-lg-3">
                     <div class="footer_widget">
                         ...
                         <ul>
                             ...
                             <li><a class="text-light" href="about.php">About us </a></li>
                             <li><a class="text-light" href="Courses.php">Courses</a></li>
                             <!-- <li ><a class="text-light" href="blog.php">Our Blog</a></li> -->
                             <li><a class="text-light" href="contact.php">Contacts</a></li>
                         </ul>
                     </div>
                 </div>
                 <div class="col-xl-3 col-md-6  col-lg-3">
                     ...
                     <div class="footer_widget">
                         ...
                         <ul>
                             <!-- <li><a  class="text-light" href="#">Term and Condition</a></li>
                                ...
                                <li><a  class="text-light" href="#"></a></li> -->
                             <li><a class="text-light" href="onlineClass.php">Online Classes</a></li>
                         </ul>
                     </div>
                 </div>
                 ...
                 <div class="col-xl-12">
                     <p class="copy_right text-center">
                         <p>
                             ...
                             </script> All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="" target="_blank">Tabish Ahmed | Mohammad Osama | Arif beig</a>
