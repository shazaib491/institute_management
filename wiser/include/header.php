...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="img/logos/title.jpg">
    ...
    <link rel="stylesheet" type="text/css" href="glide/dist/css/glide.core.css">
    <link rel="stylesheet" type="text/css" href="glide/dist/css/glide.theme.css">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="header_top_wrap d-flex justify-content-between align-items-center">
                                <div class="text_wrap">
                                    <p><span>+91 9630031012</span>&emsp;<span><a href="mailto:GIST2013@gmail.com">GIST2013@gmail.com</a></span></p>
                                </div>
                                        ...
                                        <nav class="">
                                            <ul id="navigation">
                                                ...
                                                <li><a href="#">Courses<i class="ti-angle-down"></i></a>
                                                    <ul class="submenu">
                                                        <li><a href="Courses.php">Courses</a></li>
                                                        <li><a href="onlineClass.php">Online Classes</a></li>
                                                    </ul>
                                                </li>
